...
export const mockCompanyRegistrations: CompanyRegistrationData[] = [
  {
    ...
    endPointUrl:
      'https://demo.adobeio-static.net/api/v1/web/acme/agency-event-handler',
    status: 'approved',
  ...
  },
  {
    ...
    endPointUrl:
      'https://demo.adobeio-static.net/api/v1/web/dms/agency-event-handler',
    status: 'pending',
  ...
  },
  {
    ...
    endPointUrl:
      'https://demo.adobeio-static.net/api/v1/web/bec/agency-event-handler',
    status: 'rejected',
